...
{
{text = ''..(channel_ts or "MaherBoss TEAM")..'', url=''..(channel_user_ts or 't.me/maher_1974net')..''},
},
}
local keko = "https://api.telegram.org/bot" ..token.. '/sendMessage?chat_id=' .. chat_id
if reply_to_message_id ~= 0 then
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق ماهر لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
data = JSON.decode(url)
if data.Ch_Member.TshAkE ~= true then
send(msg.chat_id_, msg.id_, 1,"✔️┇تم تفعيل المجموعه {"..(k2.title_ or "").."}", 1, 'md') 
return false end
function TSby(extra,result,success)
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'TSHAKETEAM')..')\n'
local keko2 = database:get("add"..bot_id)
...
data = JSON.decode(url)
if data.Ch_Member.TshAkE ~= true then
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت maher_1974net •\n• عليك الاشتراك في القناة 🔽 •\n• @maher_1974net ⚜️\n', 1, 'html')   
return false end
function TSby(extra,result,success)
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'TSHAKETEAM')..')\n'
if not database:get( 'tshake:'..bot_id.."charge:"..msg.chat_id_) then
...
🦁┇[قناه السورس](t.me/vpsinternetmorocco)


📮┇[لـ تواصل](t.me/stophvps)
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
------------------------------------------------------------------------
